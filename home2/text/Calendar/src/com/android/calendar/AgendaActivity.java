...
public class AgendaActivity extends Activity implements Navigator {
    ...
    protected void onResume() {
        ...
        if (mTime.year > MonthView.MAX_YEAR) {
        	mTime.year = MonthView.MAX_YEAR;
        	mTime.month = MonthView.MAX_MONTH;
        	mTime.monthDay = MonthView.MAX_MONTH_DAY;
        } else if (mTime.year < MonthView.MIN_YEAR) {
        	mTime.year = MonthView.MIN_YEAR;
        	mTime.month = MonthView.MIN_MONTH;
        	mTime.monthDay = MonthView.MIN_MONTH_DAY;
        }
