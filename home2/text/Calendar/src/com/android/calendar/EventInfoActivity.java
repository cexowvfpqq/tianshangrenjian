...
public class EventInfoActivity extends Activity implements View.OnClickListener,
 ...
 //mIsOrganizer = mCalendarOwnerAccount.equalsIgnoreCase(eventOrganizer);  //chenyulong 20120222 del
//chenyulong 20120222 add start	//del email account setting	
      try {
...
//chenyulong 20120222 add end
    ...
    private void initAttendeesCursor() {
            ...
            if (mAttendeesCursor.moveToFirst()) {
                ...
                do {
                    ...
                    if (mCalendarOwnerAttendeeId == ATTENDEE_ID_NONE &&
                      // mCalendarOwnerAccount.equalsIgnoreCase(email)) {//chenzhentao 2012-3-14 del, giving a default email.
					 email != null) { //chenzhentao 2012-3-14 add, giving a default email.
        ...
        // chenzhentao 2012-3-14 delete start, hide the organize layout
        /*
        ...
        */
        // chenzhentao 2012-3-14 delete end, hide the organize layout

        mOrganizerContainer.setVisibility(View.GONE); //chenzhentao 2012-3-14 add, hide the organize layout
    }
