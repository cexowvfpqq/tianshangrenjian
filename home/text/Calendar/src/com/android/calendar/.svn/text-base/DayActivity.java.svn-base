...
public class DayActivity extends CalendarActivity implements ViewSwitcher.ViewFactory {
    ...
    public View makeView() {
        ...
        if (mSelectedDay.year > MonthView.MAX_YEAR) {
        	mSelectedDay.year = MonthView.MAX_YEAR;
        	mSelectedDay.month = MonthView.MAX_MONTH;
        	mSelectedDay.monthDay = MonthView.MAX_MONTH_DAY;
        } else if (mSelectedDay.year < MonthView.MIN_YEAR) {
        	mSelectedDay.year = MonthView.MIN_YEAR;
        	mSelectedDay.month = MonthView.MIN_MONTH;
        	mSelectedDay.monthDay = MonthView.MIN_MONTH_DAY;
        }
